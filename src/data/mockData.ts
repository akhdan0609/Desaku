...
export const BERITA_LIST: BeritaItem[] = [
  {
    id: 'berita-1',
    judul: 'Pemerintah Desa Warung Menteng Tuntaskan Betonisasi Jalan Usaha Tani Sepanjang 1.2 KM',
    slug: 'betonisasi-jalan-usaha-tani-2026',
    kategori: 'Pembangunan',
    tanggal: '28 Agustus 2026',
    penulis: 'Tim Media Desa',
    ringkasan: 'Akses mobilitas pengangkutan hasil panen padi, salak madu, dan ikan air tawar di Dusun II kini semakin lancar dan efisien berkat rampungnya jalan usaha tani dari alokasi Dana Desa.',
    isiLengkap: `Pemerintah Desa Warung Menteng, Kecamatan Cijeruk, secara resmi menyelesaikan program betonisasi Jalan Usaha Tani (JUT) sepanjang 1.200 meter dan lebar 2,5 meter yang menghubungkan Dusun II Menteng Tengah dengan kawasan sentra budidaya kolam ikan Dusun III.

Kepala Desa Warung Menteng, H. Irfan Setiawan, S.IP., menyampaikan bahwa proyek ini merupakan prioritas hasil Musrenbangdes tahun lalu untuk memangkas ongkos logistik para petani dan pembudidaya ikan.

"Sebelumnya jalan ini berupa bebatuan licin yang sulit dilalui kendaraan roda tiga atau pikap saat musim hujan. Alhamdulillah, kini petani dan pembudidaya ikan bisa langsung mengangkut panen mereka sampai ke jalan raya dengan cepat dan aman," ujar Kades.

Warga setempat juga turut mengapresiasi transparansi anggaran pengerjaan yang melibatkan tenaga kerja lokal (Padat Karya Tunai Desa).`,
    fotoUrl: 'https://images.unsplash.com/photo-1584467735815-f778f274e296?auto=format&fit=crop&w=800&q=80',
    dibaca: 432,
    tags: ['Pembangunan', 'Dana Desa', 'Jalan Usaha Tani', 'Pertanian']
  },
  {
    id: 'berita-2',
    judul: 'Gelar Pelatihan Digital Marketing & Packaging Modern untuk 45 Pelaku UMKM Desa',
    slug: 'pelatihan-digital-marketing-umkm-2026',
    kategori: 'Kemasyarakatan',
    tanggal: '22 Agustus 2026',
    penulis: 'Sekretariat BUMDes',
    ringkasan: 'Bekerja sama dengan praktisi e-commerce dan Dinas Koperasi, pelaku UMKM dilatih teknik foto produk profesional memakai HP, sertifikasi halal gratis, dan pemasaran via WhatsApp & Marketplace.',
    isiLengkap: `Sebanyak 45 pelaku Usaha Mikro, Kecil, dan Menengah (UMKM) Desa Warung Menteng antusias mengikuti Workshop 'UMKM Naik Kelas: Dari Desa Menembus Pasar Nasional' yang digelar di Aula Kantor Desa Warung Menteng.

Materi pelatihan meliputi pembuatan kemasan standing pouch kedap udara untuk kopi dan keripik singkong, pembuatan QRIS pembayaran digital, hingga pendaftaran NIB (Nomor Induk Berusaha) instan secara mandiri.

"Kami ingin produk khas Warung Menteng seperti Kopi Menteng dan Madu Odeng tidak hanya dijual di pinggir jalan, tetapi bisa masuk toko oleh-oleh ternama dan e-commerce dengan kemasan berstandar ekspor," papar Sekretaris Desa, Asep Saepuloh.`,
    fotoUrl: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=800&q=80',
    dibaca: 318,
    tags: ['UMKM', 'Pelatihan', 'Ekonomi Desa', 'BUMDes']
  },
  {
    id: 'berita-3',
    judul: 'Posyandu Terpadu & Pemberian Makanan Tambahan (PMT) Balita Sukses Tekan Angka Stunting',
    slug: 'posyandu-pmt-stunting-warung-menteng-2026',
    kategori: 'Kesehatan',
    tanggal: '15 Agustus 2026',
    penulis: 'Kader PKK Desa',
    ringkasan: 'Kader Posyandu bersama Bidan Desa rutin memberikan asupan gizi tinggi protein berupa olahan ikan nila dan telur lokal gratis kepada balita dan ibu hamil.',
    isiLengkap: `Kader PKK bersama Bidan Desa Warung Menteng melaksanakan Posyandu serentak di 7 posko RW. Selain penimbangan balita dan imunisasi dasar lengkap, kegiatan kali ini membagikan paket PMT berbahan dasar ikan air tawar lokal segar.

Bidan Desa Bidan Rina Marlina, S.Tr.Keb., menuturkan bahwa komitmen desa mengintegrasikan potensi lokal kaya omega-3 berhasil mempertahankan predikat Desa Warung Menteng sebagai zona hijau bebas stunting di Kecamatan Cijeruk.`,
    fotoUrl: 'https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?auto=format&fit=crop&w=800&q=80',
    dibaca: 265,
    tags: ['Kesehatan', 'Posyandu', 'Zero Stunting', 'PKK']
  },
  {
    id: 'berita-4',
    judul: 'Kunjungan Wisatawan Mancanegara ke Sentra Budidaya Air Deras & Curug Pelangi Cimenteng',
    slug: 'wisatawan-mancanegara-kunjungi-warung-menteng',
    kategori: 'Pertanian',
    tanggal: '05 Agustus 2026',
    penulis: 'Pokdarwis Menteng Asri',
    ringkasan: 'Rombongan pegiat agrowisata dari Jepang dan Korea mengagumi sistem perairan gravitasi alami tanpa pompa yang digunakan warga untuk budidaya ikan nila dan pengairan sawah.',
    isiLengkap: `Desa Warung Menteng menerima kunjungan studi lapangan dari komunitas agrowisata berkelanjutan internasional. Para peserta diajak menyusuri pematang sawah, memberi pakan ikan di kolam air deras, hingga menikmati jamuan liwet daun pisang khas Sunda di tepi Curug Pelangi.

Ketua Pokdarwis, Kang Yusuf, menyatakan bahwa potensi wisata berbasis ekologi dan budaya ini akan terus dikembangkan tanpa merusak keasrian alam pegunungan.`,
    fotoUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=800&q=80',
    dibaca: 512,
    tags: ['Pariwisata', 'Perikanan', 'Ekowisata', 'Pokdarwis']
  }
];

        ...
        <section className="bg-white rounded-3xl sm:rounded-[36px] border border-slate-200/90 p-6 sm:p-8 lg:p-10 shadow-xs relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-6 space-y-5 lg:pr-4">
              ...
              {/* Story Paragraph 6 */}
              <p className="text-xs sm:text-[13px] text-slate-600 leading-relaxed text-justify">
                Tanggal 3 Oktober 2024 menjadi hari perpisahan kami dengan Desa Warung Menteng. Dengan penuh haru, kami pamit kepada warga yang sudah kami anggap seperti keluarga sendiri. Meskipun perjalanan KKN ini berakhir, hubungan dan kenangan yang telah terjalin akan selalu kami bawa dalam hati.
              </p>
